...
### 4. Translate (⚠️ Not Currently Working)

```
⚠️ KNOWN ISSUE: This feature is not yet fully functional.
See Troubleshooting section for workarounds.
```

### 5. Confirm and Use (Publish to Website)
...
AI SEO Tools tab
↓
Review Generated Content section
↓
Review SERP Preview to see how it will appear in search results
↓
Click "✓ Confirm and Use"
↓
Product description is updated
↓
Product is automatically published on website (if Website module is active)
↓
...
⚠️ **Note:** The automatic translation feature is currently **not fully functional**. See [Troubleshooting](#issue-translation-not-working) section for current limitations and workarounds.
...
## SERP Preview & Confirmation Workflow

### What is SERP Preview?

**SERP** = Search Engine Results Page

The SERP Preview shows exactly how your product will appear in Google search results:

```
╔════════════════════════════════════════════════════════════════╗
║  ▶ Premium Wireless Headphones | Best Sound Quality            ║  ← Meta Title (60 chars max)
║    www.example.com › shop › products                           ║
║    📅 May 15, 2025                                              ║
║    Experience exceptional audio with our premium wireless...    ║  ← Meta Description (160 chars max)
║                                                                ║
║    Keywords: headphones, wireless, audio, premium              ║
╚════════════════════════════════════════════════════════════════╝
```
...
1. Generate Description
   ↓
   [AI creates: description, meta_title, meta_description]

2. Generate Meta-Tags
   ↓
   [AI creates: meta_title, meta_description, meta_keywords]

3. Review SERP Preview
   ↓
   [Visual preview shows search appearance]
   [User can edit meta-tags manually if needed]

4. Click "Confirm and Use"
   ↓
   [Actions performed]:
   ├─ Copy ai_generated_description → product.description
   ├─ Keeps meta_title, meta_description, meta_keywords
   ├─ Publish on website (if Website module active)
...
### Why Use "Confirm and Use"?

✅ One-click confirmation ensures consistency
✅ Automatic website publication (no manual steps)
✅ Complete audit trail of all confirmations
✅ Safe - original AI content preserved for comparison
✅ Reversible - can edit description anytime after
...
⚠️ **KNOWN ISSUE - Translation feature is currently not fully functional**

**Current Status:**
The multi-language translation feature ("Translate All" button) is currently **not working correctly**. 

**What Happens:**
- ❌ Translations are generated by AI but fail to save properly to the database
- ❌ The `ir.translation` system integration needs to be fixed
- ❌ Multiple translations may overwrite each other instead of being stored separately per language

**Workaround (Temporary):**
For now, you can:
1. Generate descriptions in Italian, English, Spanish, etc. separately
2. Manually copy each translated description to the appropriate language version
3. Use the "Confirm and Use" button to publish each language version

**What We're Working On:**
- Proper field configuration as translatable in the Odoo model
- Direct integration with Odoo's `ir.translation` system
- Per-language description management

We apologize for this limitation. This feature will be fully functional in an upcoming version.

### Issue: "Confirm and Use" Button Disabled or Shows Error

**Solution:**
1. Ensure you have generated a description first (Generate SEO Description button)
2. Wait for generation to complete and show "Generated" status
3. Check that meta-tags are also generated
4. If website publication fails:
   - Verify Website module is installed (Apps → Search "website")
   - Check user permissions (should have "Website Editor" role)
   - Product might already be published, which is OK
